...
const videoData = [
  ...
  {
    num: "02",
    title: "Redesign CNN training algorithm",
    content: [
  ...
  {
    num: "03",
    title: "Perform hyper parameter tweaking",
    content: [
  ...
  {
    num: "04",
    title: "Compare results, Optimize format",
    content: [
  ...
  {
    num: "05",
    title: "Implement FT based version",
    content: [
  ...
  {
    num: "06",
    title: "Implement DCP based version",
    content: [
